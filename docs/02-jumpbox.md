...
```bash
{
  ...
  tar -xvf downloads/crictl-v*-linux-${ARCH}.tar.gz \
    -C downloads/worker/
  tar -xvf downloads/containerd-*-linux-${ARCH}.tar.gz \
    --strip-components 1 \
    -C downloads/worker/
  tar -xvf downloads/cni-plugins-linux-${ARCH}-v*.tgz \
    -C downloads/cni-plugins/
  tar -xvf downloads/etcd-v*-linux-${ARCH}.tar.gz \
    -C downloads/ \
    --strip-components 1 \
